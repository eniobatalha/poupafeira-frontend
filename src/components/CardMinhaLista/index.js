...
export default function CardMinhaLista({ id, nome, img, quantidade, medida }) {
    ...
    return (
        <div className="flex rounded-lg w-[90vw] h-[110px] bg-white">
            ...
            <div className="w-[30%] flex flex-col justify-center items-center text-bold">
                <h5 className="text-[20px] font-bold">{nome}</h5>
                <h5 className="text-[15px]">{quantidade}{medida}</h5>
            </div>
