...
export default function Page() {
    ...
    return (
        <div className="bg-[#254969] h-[100vh] flex flex-col justify-center items-center relative">
            <Image className="mt-[20px]" src={selectedMercado?.img} width={100} height={100} alt="Logo do mercado" />
            ...
            <div className='flex flex-col items-center overflow-auto h-[50vh] mt-3 bg-white w-[80vw] rounded-md mb-3'>
                {selecitonMercadorias.map((item, index) => (
                    <div key={index} className="flex justify-between w-[85vw] items-center max-w-[300px] m-2">
            ...
            <Link href="/produtos">
                <div onClick={handelFinalizarCompra} style={{ border: '1px solid #fff', borderRadius: '20px', color: '#fff' }} className='w-[300px] h-[50px] text-[20px] flex justify-center items-center my-6'><b>FINALIZAR COMPRAS</b></div>
            </Link>
        </div>
    );
}